...
declare type BalansolSwapInstructionArgs = {
    pool: PublicKey;
    taxMan: PublicKey;
    treasurer: PublicKey;
...
declare type DradexSwapInstructionArgs = {
    pair: PublicKey;
    market: PublicKey;
...
declare type CremaSwapInstructionArgs = {
...
declare type MarcoPoloSwapInstructionArgs = {
    pool: PublicKey;
    tokenX: PublicKey;
    tokenY: PublicKey;
...
declare type RaydiumClmmInstructionArgs = {
    ammConfig: PublicKey;
    poolState: PublicKey;
    inputVault: PublicKey;
    outputVault: PublicKey;
